            ...
            $.ajax({
                ...
                success	: function (res) {
                    ...
                    if(result.code == 0){
                        ...
                        $('#outAddress').chosen({"width":250}).trigger("chosen:updated");
                    }
                }
            });
        },*/
    ...
    var _addTask= {
        ...
        bindEvent: function () {
                        ...
                        FunL:function(){
                            ...
                            _addTask_service.submitTask(data, function (res) {
                                ...
                                if (result.code == 0) {
                                    ...
                                    window.location.href = "wmsNHOrderOutStereoscopicList.html";
                                }
                                else {
            ...
            $(document).on('click', '.return', function (){
                ...
                var userDefined3 = param.split(",")[2];
                if(userDefined3==50){
                    window.location.href   = "wmsNHYCLOrderOutStereoscopicList.html";
                } else if(userDefined3==10){
                    window.location.href   = "wmsNHCPOrderOutStereoscopicList.html";
                } else{
                    window.location.href   = "wmsNHOrderOutStereoscopicList.html";
                }
        ...
        loadOrderDetailInfo : function () {
            ...
            if( param=="" || param==null){
                ...
                if(type == '0'){
                    ...
                    //编辑
                $(".breadcrumb").find(".active").text('出库单详情');
        ...
        orderInfoSource:function (data) {
            ...
            console.log("data.userDefined3:" + data[0].userDefined3);
            var _this=this;
            ...
            //成品还是原材料
            if(data[0].userDefined3 ==50 ){
                $("#yuancailiao").show();
            }
            if(data[0].userDefined3 ==10 ){
                $("#chengpin").show();
            }
