...
public class WmsOrderOutPlaneDeailDTO {

    private List<PalletDTO> pallets;

    private Integer currentRealAmount;
    ...
    public String getOrderOutDetailId() {
        return orderOutDetailId;
    }

    public void setOrderOutDetailId(String orderOutDetailId) {
        this.orderOutDetailId = orderOutDetailId == null ? null : orderOutDetailId.trim();
    }
    ...
    public void setOrderOutId(String orderOutId) {
        this.orderOutId = orderOutId == null ? null : orderOutId.trim();
    }
    ...
    public Integer getCurrentRealAmount() {
        return currentRealAmount;
    }

    public void setCurrentRealAmount(Integer currentRealAmount) {
