var Confirm = {
    ...
    init: function(size) {
		...
		$(ElemHtml).css('position','absolute');
		$(ElemHtml).css('top','0px');
		$(ElemHtml).css('bottom','0px');
//		$(ElemHtml).css('top','500px');
    ...
    addCustomButtons: function() {
        ...
        $.each(self.customButton, function(key, val) {
            ...
            ElemHtml =   '<button id="button-' + buttonName.toLowerCase() + '" type="button" class="btn modal-custom-button ' + ButtonState + '">' + buttonName + '</button>'+closeButton;
