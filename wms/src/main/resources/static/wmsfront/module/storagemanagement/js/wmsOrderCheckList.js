...
$(function(){
    _box_service={
        ...
        getOutAddress : function(resolve, reject){
            $.ajax({
                type	:"get",
                url		: $.mpbGetHeaderPath()+"/wmsAddressRealRela/getCheckOutAddress",
        ...
        getEdgeBoxs: function(edgeBoxInfo,resolve, reject){
            $.ajax({
                type	:"post",
                url		: $.mpbGetHeaderPath()+"/wmsOrderCheck/list",
                headers:{'token':localStorage.getItem('token')},
                data	: edgeBoxInfo,
                success	: resolve,
                error	: reject
        ...
        deleteEdgeBoxInfo: function(checkId,resolve, reject){
            ...
            $.ajax({
                type		:"post",
                url		: $.mpbGetHeaderPath()+"/wmsOrderCheck/deleteByCheckId",
                headers:{'token':localStorage.getItem('token')},
                data		: data,
                success		: resolve,
                error		: reject
        ...
        deleteEdgeBoxInfo1: function(orderNo,resolve, reject){
            ...
            $.ajax({
                type		:"post",
                url		: $.mpbGetHeaderPath()+"/wmsOrderCheck/deleteByOrderNo",
                headers:{'token':localStorage.getItem('token')},
                data		: data,
                success		: resolve,
                error		: reject
    ...
    _edgeBox= {
        ...
        bindEvent: function () {
            ...
            $(document).on('click', '#showDiff', function () {
                ...
                window.location.href="wmsOrderCheckPalletList.html?orderNo=" + monitorStr;
            });
            //点击 立库启动出库【校验】
            $(document).on('click', '#startOut', function () {
                ...
                $.ajax({
                    type	:"POST",
                    url		: $.mpbGetHeaderPath()+"/wmsOrderCheck/start/check",
                    headers:{'token':localStorage.getItem('token')},
                    data    : data,
                    async   : false,
                    success	: function (res) {
            ...
            $("#modalSaveButton2").on("click",function () {
                ...
                $.ajax({
                    type	:"POST",
                    url		: $.mpbGetHeaderPath()+"/wmsOrderCheck/start",
                    headers:{'token':localStorage.getItem('token')},
                    data    : data,
                    async   : false,
                    success	: function (res) {
            ...
            $("#modalSaveButton").on("click",function () {
                ...
                $.ajax({
                    type	:"POST",
                    url		: $.mpbGetHeaderPath()+"/wmsOrderCheck/c",
                    headers:{'token':localStorage.getItem('token')},
                    data    : data,
                    async   : false,
                    success	: function (res) {
