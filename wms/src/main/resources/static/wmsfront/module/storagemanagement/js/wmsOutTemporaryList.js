...
$(function(){
    _buz_service={
        ...
        getDataList : function(data, resolve, reject){
            $.ajax({
                type	:"post",
                url		: $.mpbGetHeaderPath()+"/wmsOutTemporary/list",
    ...
    _frontBasic = {
        ...
        basicListSource : function(list) {
            ...
            for(var ele in list){
                ...
                tbody +=  '<td><a  onclick="editSelect(\''+list[ele].goodsCode+'\')" > <i class="fa-table-line-look" title="查看"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
                tbody += '</td>'+'</tr>';
            }
    ...
    $("#exportExcel").on("click",function () {
        ...
        window.location.href=$.mpbGetHeaderPath()+"/excel/outtemporary?goodsCode="+goodsCode;
    });
...
function editSelect(goodsCode) {
    window.location.href="WmsOutTemporaryBoxBarcodeList.html?goodsCode="+goodsCode;
}
