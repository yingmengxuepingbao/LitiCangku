...
public class LedUtils {
    ...
    public static final String IP1 = "";
    public static final String IP2 = "";
    public static final String IP3 = "";
    public static final String IP4 = "";

    public static final HashMap<String, String> ipMap = new HashMap<String, String>(){{
        put("115", IP1);
        put("116", IP2);
        put("117", IP3);
        put("118", IP4);
    ...
    public static void SendProgramIn(String IP
        ...
        log.info("ip地址"+IP+"批次号："+batch +"物料编码"+materialCode+"母托盘码:"+motherTray+"任务id:"+taskId+"问题表述:"+warning+"标题:"+title );
...
//        pf.addArea(area13);
    ...
    public void sendOut(String IP,
        ...
        try {
            ...
            TextCaptionBxArea area11 = new TextCaptionBxArea(0, 0, 120, 20, screen.getProfile());
            TextCaptionBxArea area12 = new TextCaptionBxArea(70, 0, 60, 20, screen.getProfile());
//        TextCaptionBxArea area13 = new TextCaptionBxArea( 0,25,250,5,screen.getProfile());
...
//        pf.addArea(area13);
            ...
            e.printStackTrace();
            log.info("发送到LED失败:" + e.getMessage());
        }
    }
}
